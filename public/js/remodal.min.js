...
$(function () {
  ...
  $("#tag_id").each(function (i) {
    ...
    $('a[href = "#remodal-select' + i + '"]').text(selected_text); // モーダルウィンドウを開くリンク生成
  ...
  $(".remodal-select").each(function (i) {
    ...
    $(this).find("li").on("click", function () {
      ...
      $("#select" + i).val([value]);
      $('a[href = "#remodal-select' + i + '"]').text(text); // class付与
...
module.exports = __webpack_require__(/*! /var/www/resources/js/remodal/remodal.min.js */"./resources/js/remodal/remodal.min.js");
