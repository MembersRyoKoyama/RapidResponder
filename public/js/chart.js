...
/* harmony import */ var _sass_variables_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sass/_variables.scss */ "./resources/sass/_variables.scss");
...
$(document).ready(function () {
  ...
  var myPieChart = new Chart(pieCtx, {
    ...
    data: {
      labels: ["未対応", "対応中", "対応済"],
      datasets: [{
        backgroundColor: [_sass_variables_scss__WEBPACK_IMPORTED_MODULE_0___default.a.end1, _sass_variables_scss__WEBPACK_IMPORTED_MODULE_0___default.a.end2, _sass_variables_scss__WEBPACK_IMPORTED_MODULE_0___default.a.end3],
        data: Laravel.pie,
        borderWidth: 0
      }]
    },
  ...
  var myBarChart = new Chart(barCtx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: _sass_variables_scss__WEBPACK_IMPORTED_MODULE_0___default.a.end1
      }, {
        label: "対応中",
        data: Laravel.bar.datas.end2,
        backgroundColor: _sass_variables_scss__WEBPACK_IMPORTED_MODULE_0___default.a.end2
      }, {
        label: "対応済",
        data: Laravel.bar.datas.end3,
        backgroundColor: _sass_variables_scss__WEBPACK_IMPORTED_MODULE_0___default.a.end3
      }]
    },
    options: {
      title: {
